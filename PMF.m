...
%     pause(0.5)
    if rem(siml,every)==0
        eval( ['save siml', int2str(siml),' siml shP shN shZ fi every']);
        eval( ['save loader ','siml']);
        figure(1);
