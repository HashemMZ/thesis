function code = sqarithencoflushTot(seq,counts,N,E3_max,midFS)
%
%    code = sqarithencoflushTot(seq,counts,N,E3_max,midFS)
%
% Encode a sequence of symbols using quasi-arithmetic coding. it is
...
interval=[0 2^N-1] ;flw=0;state=[interval,flw];
